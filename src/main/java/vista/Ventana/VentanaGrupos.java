...
public class VentanaGrupos extends JPanel {
    ...
    public VentanaGrupos(VentanaInicio mainFrame, ControladorAppChat controlador) {
        ...
        // No se asigna ningún color de fondo para que se usen los valores por defecto
    ...
    // Método que crea botones sin asignar colores personalizados
    private JButton createStyledButton(String text) {
        JButton button = new JButton(text);
        button.setFont(new Font("Segoe UI", Font.BOLD, 14));
        button.setFocusPainted(false);
        button.setCursor(new Cursor(Cursor.HAND_CURSOR));
        // No se definen colores de fondo, primer plano ni bordes personalizados
        return button;
    }
